  ...
  return (
    <div>
      ...
      <div style={{ padding: '17%' }}>
        <h2>Bus Tickets</h2>
        <p>Enjoy a comfortable and safe journey with our easy and reliable bus ticket booking service.</p>
        ...
        <form onSubmit={handleSubmit} style={formStyle}>
          ...
          <button type="submit" style={submitButtonStyle}>Show Buses</button>
        </form>
      </div>
    </div>
  );
